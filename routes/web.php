...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['prefix' => 'circuito', 'where' => ['id'=>'[0-9]+']], function () {
        ...
        Route::delete('{id}/destroy',      [CircuitoController::class, 'destroy'])->name('circuito.destroy');
    ...
    Route::group(['prefix' => 'piloto', 'where' => ['id'=>'[0-9]+']], function () {
        ...
        Route::delete('{id}/destroy',      [PilotoController::class, 'destroy'])->name('piloto.destroy');
    ...
    Route::group(['prefix' => 'equipe', 'where' => ['id'=>'[0-9]+']], function () {
        ...
        Route::delete('{id}/destroy',      [EquipeController::class, 'destroy'])->name('equipe.destroy');
    ...
    Route::group(['prefix' => 'pais', 'where' => ['id'=>'[0-9]+']], function () {
        ...
        Route::delete('{id}/destroy',      [PaisController::class, 'destroy'])->name('pais.destroy');
    ...
    Route::group(['prefix' => 'cidade', 'where' => ['id'=>'[0-9]+']], function () {
        ...
        Route::delete('{id}/destroy',      [CidadeController::class, 'destroy'])->name('cidade.destroy');
